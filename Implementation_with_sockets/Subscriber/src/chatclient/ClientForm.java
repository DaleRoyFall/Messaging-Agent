...
public class ClientForm extends javax.swing.JFrame {
     ...
     */
    public ClientForm(Socket clientSocket, String name, String group, int port) {
        initComponents();
        ...
        try {
            ...
            dataOutputStream.writeUTF("\\connect:" + name + "|" + group);
    ...
    private void initComponents() {
        ...
        sendMessageButton.setBounds(410, 350, 80, 25);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientForm(null, null, null, 0).setVisible(true);
            }
        });
    }
